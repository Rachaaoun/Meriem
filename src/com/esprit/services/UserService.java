...
public class UserService {
    ...
    public ArrayList<User> parseTasks(String jsonText){
       ...
       public  boolean modifierUser(User u)  {
        ...
        String url = Statics.BASE_URL + "/user/modifier/utilisateur/"+u.getId()+"?nom=" + u.getNom() + "&prenom=" + u.getPrenom() + "&adresse=" + u.getAdresse()+ "&email=" + u.getEmail()+ "&password=" + u.getPassword()+ "&numTel=" +u.getNumTel()+ "&username=" +u.getUsername()+ "&status=" +u.getStatus();
       req.setUrl(url);
    ...
    public void addUser(User u)  {
        ...
        String url = Statics.BASE_URL + "/user/ajouter/utilisateur?nom=" + u.getNom() + "&prenom=" + u.getPrenom() + "&adresse=" + u.getAdresse()+ "&email=" + u.getEmail()+ "&password=" + u.getPassword()+ "&numTel=" +u.getNumTel()+ "&username=" +u.getUsername()+ "&status=" +u.getStatus();
        req.setUrl(url);
    ...
    */
    ...
    public boolean deleteUser(int id ) {
        String url = Statics.BASE_URL +"/user/delete/utilisateur/json/"+id;
