...
//        addTab(swipe,s1, res.getImage("back-logo.jpeg"),"","",res);
        ...
        System.out.println("user connecté username ="+ SessionManager.getNom());
        
        System.out.println("user connecté password ="+ SessionManager.getPassoword());
...
//        rbs[0].setSelected(true);
        ...
        RadioButton mesListes = RadioButton.createToggle("Utilisateurs List ", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Autres", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("User", barGroup);
...
//        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
    ...
    private void addButton(Image img,User u , Resources res) {
       ...
       // Label objetTxt = new Label("Date : "+rec.getDate(),"NewsTopLine2");
        Label adresseTxt = new Label("Adresse: "+u.getAdresse(),"NewsTopLine2");
        Label nomTxt = new Label("Nom : "+u.getNom(),"NewsTopLine2" );
        Label prenomTxt = new Label("Prenom : "+u.getPrenom(),"NewsTopLine2" );
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(prenomTxt,lModifier,lSupprimer)));
